...
namespace TMDBGateway.TMDBServices
{
    ...
    public class TMDBGateWayService
    {
        ...
        private static TMDBGateWayService instance;

        private TMDBGateWayService() { }

        public static TMDBGateWayService Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new TMDBGateWayService();
                }
                return instance;
            }
        }
        ...
        public Movie GetMovie(int id)
        {
            ...
            {
                HttpResponseMessage response =
                    client.GetAsync("https://api.themoviedb.org/3/movie/"+id+"?api_key=" + APIKey).Result;
